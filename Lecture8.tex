...
\begin{example}
    $X = \mathbb{N}$, the basis $U_m = \{0, 1, 2 \cdots, m\}$. $\mathcal{T} = \{U_m | m\in \mathbb{N}, \mathbb{N}, \emptyset\}$. Then $x_n$ converges to $a$ if and only if $a$ is essential upper bound of $\{ x_n \}$. In this case, the limit is not unique. 
\end{example}

\begin{example}
    Finite complement topology on $\mathbb{R}$. For example take $\mathcal{T} = \{ \mathbb{R}, \emptyset, \mathbb{R}\setminus \{p_1, p_2, \cdots, p_m\}\}$. 
    \begin{enumerate}
