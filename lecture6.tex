...
\begin{theorem}
    If $\mathcal{B}$ is a basis of a topology $\mathcal{U}$ on $X$, then for any open set $U \in \mathcal{U}$, we have $U = \bigcup_{B \in \mathcal{B}, B \subseteq U} B$. (The Proof is based on the wrong definition of basis in the previous version.)
\end{theorem}
\par \noindent \textbf{Proof}
...
\begin{example}
    ...
    \begin{equation}
        S = \{\pi_1^{-1}(U)| U \subseteq \mathcal{U}\} \cup \{\pi_2^{-1}(V) | V \subseteq \mathcal{V}\} 
    \end{equation}
